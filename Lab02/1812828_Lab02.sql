...
CREATE DATABASE 1812828_Database_Lab02;
...
select salesRepEmployeeNumber, country from customers where country='USA' and salesRepEmployeeNumber <>1165;
...
-- g. Lọc ra danh sách các đơn hàng có ngày yêu cầu vận chuyển là ‘18/1/2003’. 
select orderNumber, requiredDate from orders where requiredDate = '2003-01-18';

-- Lưu ý: MySQL lưu dữ liệu ngày tháng theo định dạng năm/tháng/ngày.

-- h. Lọc ra danh sách các đơn hàng có ngày đặt trong tháng 5 năm 2005 và có trạng thái là ‘Shipped’ 
select orderNumber, orderDate, status
 from orders
 where  year(orderDate)='2005' and month(orderDate)='5'  and status='Shipped';
...
-- k. Lấy ra thông tin về 5 khách hàng đầu tiên hiện đang ở ‘USA’
